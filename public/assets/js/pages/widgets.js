...
var KTWidgets = function () {
    ...
    var _sales_yoy = function () {
        var element = document.getElementById("sales_yoy_graph");
        ...
        var options = {
            ...
            xaxis: {
                categories:  Object.keys(sales_yoy),
                axisBorder: {
                    show: false,
                },
                axisTicks: {
    ...
    var _monthly_user = function () {
        var element = document.getElementById("_monthly_user");
        ...
        var options = {
            ...
            colors: [KTApp.getSettings()['colors']['theme']['light']['primary'] , KTApp.getSettings()['colors']['theme']['light']['danger']],
            markers: {
                colors: [KTApp.getSettings()['colors']['theme']['light'][color]],
                strokeColor: [KTApp.getSettings()['colors']['theme']['base'][color]],
                strokeWidth: 3
    ...
    var _all_user = function () {
        const apexChart = "#_all_user";
		var options = {
			series: [{
				name: "Desktops",
				data: []
        ...
        $.ajax({
            url: "/admin/analytic/get/user/all",
            type: "GET",
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
            success: function(data) {
                chart.updateSeries([{
                  ...
                  chart.updateOptions({
                        xaxis: {
                            categories: Object.keys(JSON.parse(data)),
                        }
                    })
            }
        });
        
        // var element = document.getElementById("_all_user");
