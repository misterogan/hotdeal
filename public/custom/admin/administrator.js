...
$("#btn_cancel").on("click", function() {
    location.href = '/admin/administrator';
});

$("#create_administrator_form").on("submit", function (event) {
...
$("#edit_administrator_form").on("submit", function (event) {
    event.preventDefault();
    var token = $('meta[name="csrf-token"]').attr('content');
    var formData = new FormData(this);
    $.ajax({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        return '<a href="/admin/administrator/edit/'+full.id+'">'+data+'</a>'
                    }
                },
                {
                    targets: 3,
