$("#btn_cancel").on("click", function() {
    location.href = '/admin/highlight';
});

$("#create_highlight_form").on("submit", function (event) {
...
$("#set_highlight_title").on("submit", function (event) {
    event.preventDefault();
    var token = $('meta[name="csrf-token"]').attr('content');
    var formData = new FormData(this);
    $.ajax({
        ...
        success: function(data){
            if(data.status === true) {
                swal.fire({
                    ...
                    location.href = "admin/highlight/title";
                });
            }else {
                var values = '';
                jQuery.each(data.message, function (key, value) {
...
$("#edit_highlight_form").on("submit", function (event) {
    event.preventDefault();
    var token = $('meta[name="csrf-token"]').attr('content');
    var formData = new FormData(this);
    $.ajax({
    ...
    if (table != null) {
        table.DataTable({
            ...
            columns: [
                ...
                { data: 'highlight_type', name: 'Highlight Type'},
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        return '<a href="/admin/highlight/edit/'+full.id+'">'+data+'</a>'
                    }
                },
                {
                    targets: 4,
