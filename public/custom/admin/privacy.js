...
$("#btn_cancel").on("click", function() {
    location.href = '/admin/privacy-policy';
});

$("#create_privacy_form").on("submit", function (event) {
...
$("#edit_privacy_form").on("submit", function (event) {
    event.preventDefault();
    var token = $('meta[name="csrf-token"]').attr('content');
    var formData = new FormData(this);
    $.ajax({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        return '<a href="/admin/privacy/edit/'+full.id+'">'+data+'</a>'
                    }
                },
                {
                    targets: 3,
