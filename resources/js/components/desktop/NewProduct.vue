<template>
    <div class="col box-recommended">
        ...
        <div v-if="!is_loading">
            ...
            <div class="section-product" v-if="Object.keys(recomendation).length > 0">
    ...
    export default {
        ...
        methods: {
            recomendationProduct(){
                const element = document.querySelector("#ob_product_new");
                this.observer = new IntersectionObserver(entries => {
                    const target = entries[0];
                    if (target.isIntersecting) {
                        apiCustomer.productRecomedation().then( response => {
