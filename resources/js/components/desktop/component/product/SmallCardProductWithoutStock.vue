    ...
    <div class="card">
        <div class="card-product">
            <router-link :to="'/product-detail/'+item.slug">
                ...
                <div class="detail-product">
                    <div class="product-info">
                        <rating class="mbottom-5" :rating="item.rating" :count_rating="item.review"></rating>
                        <div class="tooltip">
            ...
            <div class="vertical-btn">
                <wish-component class="add-to-wish" :clases="item.in_wish_list == true ? 'active' : '' " :slug="item.slug"></wish-component>
