<template>
    <div class="card">
        <div class="card-product" v-if="item">
                ...
                <div class="detail-product">
                    <div class="product-info">
                        ...
                        <div class="price mbottom-5 mtop-3">
                            ...
                            <p class="discount" v-if="item.discount_value > 0">{{item.discount_value}}%</p>
                        </div>
                    </div>
                    <div class="tag mbottom-5 mtop-5">
                        <!-- <div class="free-ongkir">
                            <p > Gratis Ongkir {{item.shipping_fee_discount | RupiahFormat}}</p>
                        </div> -->
            ...
            <div class="vertical-btn">
                <wish-component class="add-to-wish" :slug='item.slug' :clases="item.in_wish_list == true ? 'active' : '' " ></wish-component>
...
<script>
    ...
    export default {
        ...
        name: "SmallCardProductWithoutStockHighlight",
        props :['item'],
        mounted(){
        },
        components : {
