<template>
    <div id="pinpoint_address_edit_modal" class="modal">
                    ...
                    <div class="modal-pinpoint mbottom-20">
                        ...
                        <form autocomplete="off" class="form-pin-point scroll-overflow h-450">
                            ...
                            <div class="pin-point maps-show d-none">
                                ...
                                <div class="maps" id="mapedit" ref="map_edit"></div>
    ...
    export default {
        ...
        methods: {
                    ...
                    if (this.$v.$invalid) {
                        ...
                        Customer.update_address(this.form).then(response => {
                            ...
                            if(response.data.code == 200){
                               ...
                               $("#pinpoint_address_edit_modal").fadeOut(function () {
            ...
            showLocationOnTheMap(latitude, longitude) {
                var map = new google.maps.Map(this.$refs["map_edit"], {
                    zoom: 17,
