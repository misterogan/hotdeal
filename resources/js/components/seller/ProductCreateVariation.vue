                    ...
                    <div class="box add-product">
                        ...
                        <form v-on:submit.prevent="">
                                    ...
                                    <div class="media-upload">
                                        <label for="main_photo">
                                            <div class="upload-icon">
                                                <img class="icon preview_main_photo" src="/img/ic_add.svg">
                                            </div>
                                        </label>
                                        <input id="main_photo" type="file" class="add-image" ref="main_photo" @change="imageChange($event , 'main_photo' , 'photo')">
                                        <h6 @click="$refs.main_photo.click()">foto utama</h6>
                                    </div>
                                </div>
                                <div class="add-media">
                                    <div class="media-upload">
                                    ...
                                    <div class="body-variation" v-for="(item , index) in form.variant_1.variant" :key="index">
                                        ...
                                        <div style="width:100%" v-if="variant_2_status == true">
                                            <div class="child-table" v-for="(item2 , index2) in form.variant_2.variant" :key="index2">
                                                ...
                                                <div class="col"><input type="text" :name="'sku_'+index+'_'+index2" placeholder="kode variasi"></div>
                                            </div>
                                        </div>
                            ...
                            <div class="input-weight">
                                <div class="form-group">
                                    <h5>berat</h5>
                                    <input type="number" name="weight" v-model.trim="$v.form.weight.$model" placeholder="Masukkan berat barang, contoh : 100 gram">
                            ...
                            <div class="col select-option" style="width:20%; display: none">
                                <h5>status</h5>
...
<script>
    ...
    export default {
        ...
        mounted(){
            // apiMaster.Categories().then(response => {
            // })
        },
        methods :{
            setcategory(event){
