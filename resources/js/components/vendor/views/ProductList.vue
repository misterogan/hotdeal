        ...
        <div class="col-xxl-3">
          ...
          <div class="card card-xl-stretch mb-xl-8">
            ...
            <div class="card-header border-0 bg-primary py-5">
              <h3 class="card-title fw-bolder text-white">Hotdeal Seller Center</h3>
            </div>
            <!--end::Header-->
            <!--begin::Body-->
            <div class="card-body bg-primary p-0">\
              ...
              <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                      <span class="menu-link">
                        ...
                        <span class="menu-title">Bisnis Saya</span>
                        <span class="menu-arrow"></span>
                      </span>
                      <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
              ...
              <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                      <span class="menu-link">
                        ...
                        <span class="menu-title">Kesehatan Toko</span>
                        <span class="menu-arrow"></span>
                      </span>
                      <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
              ...
              <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                      <span class="menu-link">
                        ...
                        <span class="menu-title">Lain - lain</span>
                        <span class="menu-arrow"></span>
                      </span>
                      <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
