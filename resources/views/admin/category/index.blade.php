...
@section('content')
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">Category
                    <span class="d-block text-muted pt-2 font-size-sm">Data for category</span></h3>
            </div>
        ...
        <div class="card-body">
            ...
            <div class="card-body">
                <!--begin: Datatable-->
                <table id="dt_category" class="table datatable datatable-bordered datatable-head-custom">
                    <thead>
                    <tr>
                        <th></th>
                        <th>No. </th>
