                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header">
                            <h3 class="card-title">FAQs Edit Form</h3>
                        </div>
                        <!--begin::Form-->
                        <form class="form" id="edit_faq_form"  enctype="multipart/form-data" >
                            @csrf
                            ...
                            <div class="card-body">
                                <div class="mb-15">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="title" id="title" class="form-control" placeholder="Enter Title" value="{{ $faq->title }}" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="question" id="question" class="form-control" placeholder="Enter Question" value="{{ $faq->question }}" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea id="answer" name="answer" class="form-control summernote">{!! $faq->answer !!}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="image-input image-input-outline" id="kt_image_12">
                                                <div class="image-input-wrapper" style="background-image: url({{ isset($faq->image) ? $faq->image : "assets/media/misc/img-placeholder-landscape.png" }}); width: 250px;"></div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9 col-form-label">
                                            <div class="radio-inline">
                                                <label class="radio">
                                                    <input type="radio" name="status" value="active" {{ $faq->status == 'active' ? 'checked' : '' }}/>
                                                    <span></span>Active</label>
                                                <label class="radio">
                                                    <input type="radio" name="status" value="inactive" {{ $faq->status == 'inactive' ? 'checked' : '' }}/>
