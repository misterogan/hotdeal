                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header">
                            <h3 class="card-title">Edit Highlight Product</h3>
                        ...
                        <!--begin::Form-->
                        <form class="form" id="edit_highlight_form"  enctype="multipart/form-data" >
                            @csrf
                            <input type="hidden" name="id" value="{{ $id }}"/>
                            <input type="hidden" name="hType" id="hType" value="{{ $data->highlight_type }}"/>
                            <div class="card-body">
                                <div class="mb-15">
                                    ...
                                    <div class="form-group row" id="deepLink" style="display:flex">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="deep_link" id="deep_link" class="form-control" value="{{ $data->deep_link }}" />
                                    ...
                                    <div class="form-group row" id="customVideo" style="display:none">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="embed-responsive embed-responsive-16by9">
                                                <iframe class="embed-responsive-item" src="{{ $data->deep_link != '' ? $data->deep_link : 'assets/media/misc/img-placeholder-portrait.png' }}"></iframe>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <label class="option">
                                                    <span class="option-control">
                                                        <span class="radio">
                                                            <input type="radio" name="highlight_type" value="1" {{ $data->highlight_type == "1" ? "checked" : "" }} onclick="highlightOption(1)"/>
                                                            <span></span>
                                                        </span>
                                                    </span>
                                            ...
                                            <div class="col-lg-6">
                                                <label class="option">
                                                    <span class="option-control">
                                                        <span class="radio">
                                                            <input type="radio" name="highlight_type" value="2" {{ $data->highlight_type == "2" ? "checked" : "" }} onclick="highlightOption(2)"/>
                                                            <span></span>
                                                        </span>
                                                    </span>
                                                    <span class="option-label">
                                            ...
                                            <div class="col-lg-6">
                                                <label class="option">
                                                    <span class="option-control">
                                                        <span class="radio">
                                                            <input type="radio" name="highlight_type" value="3" {{ $data->highlight_type == "3" ? "checked" : "" }} onclick="highlightOption(3)"/>
                                                            <span></span>
                                                        </span>
                                                    </span>
                                                    <span class="option-label">
                                            ...
                                            <div class="col-lg-6">
                                                <label class="option">
                                                    <span class="option-control">
                                                        <span class="radio">
                                                            <input type="radio" name="highlight_type" value="4" {{ $data->highlight_type == "4" ? "checked" : "" }} onclick="highlightOption(4)"/>
                                                            <span></span>
                                                        </span>
                                                    </span>
                                                    <span class="option-label">
                                            ...
                                            <div class="col-lg-6">
                                                <label class="option">
                                                    <span class="option-control">
                                                        <span class="radio">
                                                            <input type="radio" name="highlight_type" value="5" {{ $data->highlight_type == "5" ? "checked" : "" }} onclick="highlightOption(5)"/>
                                                            <span></span>
                                                        </span>
                                                    </span>
                                                    <span class="option-label">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="number" name="sequence" id="sequence" class="form-control" value="{{ (int)($data->sequence) }}"/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="image-input image-input-outline" id="kt_image_11">
                                                <div class="image-input-wrapper" style="background-image: url({{ $data->img_square ? $data->img_square : 'assets/media/misc/img-placeholder-square.png' }})"></div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="image-input image-input-outline" id="kt_image_12">
                                                <div class="image-input-wrapper" style="background-image: url({{ $data->img_landscape ? $data->img_landscape : 'assets/media/misc/img-placeholder-landscape.png' }}); width: 250px;"></div>
                                                <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="Change avatar">
                                                    <i class="fa fa-pen icon-sm text-muted"></i>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="image-input image-input-outline" id="kt_image_13">
                                                <div class="image-input-wrapper" style="background-image: url({{ $data->img_portrait ? $data->img_portrait : 'assets/media/misc/img-placeholder-portrait.png' }}); height: 250px;"></div>
                                                <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="Change avatar">
                                                    <i class="fa fa-pen icon-sm text-muted"></i>
...
@section('js')
    ...
    <script>
        ...
        $( document ).ready(function() {
            let hType = document.getElementById("hType").value;
            if (hType == 1){
        ...
        function highlightOption(value) {
            if (value === 1) {
                ...
                document.getElementById("deepLink").style.display = "none";
                document.getElementById("customVideo").style.display = "none";   
                var a = document.getElementById("deep_link").value;
            }
        }
    </script>
@endsection
