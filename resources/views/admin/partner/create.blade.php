            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <!--begin::Form-->
                        <form class="form" id="create_partner_form"  enctype="multipart/form-data" >
                            <div class="card-body">
                                <div class="mb-15">
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Partner Name:</label>
                                        <div class="col-lg-6">
                                            <input type="text" name="partner_name" id="partner_name" class="form-control" placeholder="Enter Partner name" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="partner_code" id="partner_code" class="form-control" placeholder="Enter Total Code" />
                                    ...
                                    <div class="form-group row">
                                        <label class="col-3 col-form-label">Show in Foter?</label>
                                        <div class="col-9 col-form-label">
                                            <div class="radio-inline">
                                                <label class="radio">
                                                    <input type="radio" name="footer" value="true" />
                                                    <span></span>Yes</label>
                                                <label class="radio">
                                                    <input type="radio" name="footer" value="false" />
                                                    <span></span>No</label>
                                            </div>
                                        </div>
                                    </div>
