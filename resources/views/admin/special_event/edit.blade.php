            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <!--begin::Form-->
                        <form class="form" id="edit_special_form" enctype="multipart/form-data">
                            <input type="hidden" name="event_id" id="event_id" class="form-control" placeholder="Event Name" value="{{$data->id}}" />
                            <div class="card-body">
                                <div class="mb-15">
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Event Name: </label>
                                        <div class="col-lg-6">
                                            <input type="text" name="event_name" id="event_name" class="form-control" placeholder="Event Name" value="{{$data->event_name}}" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="banner_type" id="banner_type" class="form-control" placeholder="Banner Type" value="{{$data->banner_type}}" />
                                            <span class="form-text text-muted">Please enter Event name</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="image-input image-input-outline" id="kt_image_12">
                                                <div class="image-input-wrapper" style="background-image: url({{ $data->banner_image ? $data->banner_image : 'assets/media/misc/img-placeholder-landscape.png' }}); width: 250px;"></div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea class="form-control summernote" name="tnc" style="height:500px" id="tnc">{{$data->tnc}}</textarea>
                                        </div>
                                    </div>
