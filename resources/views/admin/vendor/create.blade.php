            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <!--begin::Form-->
                            <form class="form" id="create_vendor_form"  enctype="multipart/form-data" >
                                @csrf
                            <div class="card-body">
                                <div class="mb-15">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="password" id="password" class="form-control" placeholder="Password will be auto generated and sent to user email" disabled />
                                            <span class="form-text text-muted">Password is auto-generated</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="name" id="name" class="form-control" placeholder="Enter Vendor Name" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="pic" id="pic" class="form-control" placeholder="Please enter PIC name"  />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea class="form-control" name="description" id="description" style="resize: none" placeholder="Enter Vendor Description"></textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="long" id="long" class="form-control" placeholder="Enter longtitude" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <select class="form-control" id="kt_select2_103" name="city_select" onchange="get_district(this.value)" disabled>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <select class="form-control" id="kt_select2_104" name="suburb_select" onchange="get_area(this.value)" disabled></select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <select class="form-control" id="kt_select2_105" name="area_select" disabled></select>
                                        </div>
                                    </div>
