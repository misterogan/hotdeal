						...
						<div class="login-form login-signin">
							...
							<form class="form" novalidate="novalidate" id="kt_login_signin_form">
								...
								<div class="form-group">
									<input class="form-control form-control-solid h-auto py-5 px-6" type="text" placeholder="Your OTP..." name="otp" autocomplete="off" />
								...
								<div class="form-group d-flex flex-wrap justify-content-between align-items-center">
									<button type="button" id="kt_login_otp_submit" class="btn btn-primary font-weight-bold btn-block px-9 py-4 my-3">Submit</button>
								</div>
								<!--end::Action-->
							</form>
							<!--end::Form-->
