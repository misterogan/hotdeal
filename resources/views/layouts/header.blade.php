                   ...
                   <form>
                       ...
                       <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(assets/media/misc/bg-1.jpg)">
                           ...
                           <h4 class="d-flex flex-center rounded-top">
                               <span class="text-white">Notifikasi Admin</span>
                           ...
                           <ul class="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-line-transparent-white nav-tabs-line-active-border-success mt-3 px-8" role="tablist">
                               <li class="nav-item">
                                   <a class="nav-link active show" data-toggle="tab" href="#topbar_notifications_notifications">Notifikasi</a>
                               </li>
                           </ul>
                           <!--end::Tabs-->
                       </div>
                       ...
                       <div class="tab-content">
                           ...
                           <div class="tab-pane active show p-8" id="topbar_notifications_notifications" role="tabpanel">
                               ...
                               <div class="scroll pr-7 mr-n7" data-scroll="true" data-height="300" data-mobile-height="200">
                                   ...
                                   @foreach (\Utils::admin_notification() as $item)
                                   <div class="d-flex align-items-center mb-6">
                                       ...
                                       <div class="d-flex flex-column font-weight-bold">
                                            <a href="{{$item->url}}" class="text-dark text-hover-primary mb-1 font-size-lg">{{$item->title}}</a>
                               ...
                               <div class="d-flex flex-center pt-7">
                                   <a href="/admin/notifications" class="btn btn-light-primary font-weight-bold text-center">Lihat Semua</a>
                               </div>
                               <!--end::Action-->
                           </div>
                           <!--end::Tabpane-->
